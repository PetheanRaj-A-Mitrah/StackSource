...
export interface ApiNewsletterSignUpNewsletterSignUp
  extends Struct.CollectionTypeSchema {
  collectionName: 'newsletter_sign_ups';
  info: {
    displayName: 'Newsletter SignUp';
    pluralName: 'newsletter-sign-ups';
    singularName: 'newsletter-sign-up';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::newsletter-sign-up.newsletter-sign-up'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::newsletter-sign-up.newsletter-sign-up': ApiNewsletterSignUpNewsletterSignUp;
